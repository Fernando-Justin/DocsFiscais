  ...
  return (
    <div className="flex flex-col h-screen overflow-hidden" style={{ backgroundColor: "var(--bg-page)", color: "var(--text-primary)" }}>
      ...
      <div className="flex items-center justify-between px-6 py-1.5 text-[11px] border-b"
        style={{
          backgroundColor: isSupabaseConfigured ? "var(--gcp-green-bg, #E6F4EA)" : "var(--amber-bg, #FEF7E0)",
          borderColor: "var(--border)",
          color: isSupabaseConfigured ? "var(--gcp-green, #137333)" : "var(--gcp-amber, #B06000)"
        }}>
      ...
      {/* Header Principal - Google Cloud Style */}
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2.5">
            <div className="rounded flex items-center justify-center"
              style={{ width: 30, height: 30, backgroundColor: "var(--blue-primary)" }}>
      ...
      <main className="flex-1 flex overflow-hidden" style={{ backgroundColor: "var(--bg-page)" }}>
        ...
        {/* Sidebar — Lista de Apps (Google Cloud Console Style) */}
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="input-gcp pl-8 w-full"
                />
              </div>
              <button
                onClick={() => { setSelectedAppId(null); setSelectedDetails(null); setShowCreateApp(true); }}
              ...
              filteredApps.map((app) => {
                ...
                return (
                  ...
                  >
                    ...
                    {app.proposito && (
                      <p className="text-[12px] mt-1 truncate leading-snug"
              ...
              <div className="max-w-md space-y-5">
                <div className="flex items-center justify-center">
                  <div className="rounded-xl p-4"
                    ...
                    <LayoutGrid size={30} style={{ color: "var(--blue-primary)" }} />
                  </div>
                </div>

                <div>
                  <h2 className="text-lg font-medium mb-1.5" style={{ color: "var(--text-primary)" }}>
                    Bem-vindo ao DocsFiscais
                  </h2>
                  <p className="text-[13px] leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                    Selecione uma aplicação na barra lateral para visualizar e gerenciar sua documentação técnica, endpoints, equipe e roadmap.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-3 gap-3 pt-1">
                  {[
                    ...
                    <div key={stat.label} className="rounded-lg p-3 text-left"
                      ...
                      <div className="flex items-center gap-1.5 mb-2" style={{ color: "var(--blue-primary)" }}>
                        {stat.icon}
                      </div>
                      <div className="font-semibold text-lg leading-none" style={{ color: "var(--text-primary)" }}>
                        {stat.value}
                      </div>
                ...
                <button
                  onClick={() => { setShowCreateApp(true); setSelectedAppId(null); }}
